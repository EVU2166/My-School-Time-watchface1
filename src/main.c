...
struct periodInfo normalInfo[] = { 
    {1, TIME(8,20),  TIME(9,01)},
	{2, TIME(9,03),  TIME(9,44)},
	{3, TIME(9,46),  TIME(10,27)},
	{4, TIME(10,29),  TIME(11,10)},
	{5, TIME(11,12),  TIME(11,53)},
	{6, TIME(11,56),  TIME(12,37)},
	{7, TIME(12,40), TIME(13,21)},
	{8, TIME(13,23), TIME(14,07)},
	{9, TIME(14,09), TIME(14,50)}
};
#define INFO_SIZE (sizeof(normalInfo)/sizeof(struct periodInfo))
	
#define NORMAL_START TIME(8,20)
#define NORMAL_END   TIME(14,50)
